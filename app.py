...
st.subheader("Aprende Redes, VLAN y OT mientras proteges una fábrica digital")
...
with st.sidebar:
    ...
    nivel_visual = min(st.session_state.level, 5)
    st.metric("Nivel", f"{nivel_visual}/5")

    # FIX ERROR PROGRESS BAR
    progress = min(int((nivel_visual / 5) * 100), 100)
...
if st.session_state.level == 1:
    ...
    st.header("🌐 Nivel 1 - ¿Qué es una Red?")
    ...
    if st.button("Validar Respuesta"):
        ...
        if answer == "Compartir información y recursos":
            ...
            st.success("✅ Correcto. Las redes permiten compartir información.")
...
# =========================================================
    ...
    st.header("🔀 Nivel 2 - Configurar VLANs")
...
# =========================================================
    ...
    st.header("🚨 Nivel 3 - Ataque de Red")
...
# =========================================================
    ...
    st.header("🛡️ Nivel Final - Defender la Fábrica")
    ...
    invitados = st.checkbox("⚠️ Permitir invitados en red OT")
